    ...
    <>
      ...
      <Router>
        ...
        <Routes>
          ...
          <Route path='dashboard/admin/allbrands' element={<BrandsList/>} />
          <Route path='dashboard/admin/cars' element={<Cars/>} />
          <Route path='dashboard/admin/create-brand' element={<CreateBrands/>} />
          <Route path='dashboard/admin/create-product' element={<CreateCar/>} />
          <Route path='dashboard/admin/car/:slug' element={<UpdateCar/>} />
          <Route path='dashboard/admin/userorders' element={<AdminOrders/>} />
